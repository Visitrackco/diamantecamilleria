...
async getHistory() {
  ...
  if (login) {
    try {
      ...
      const rs = await this.api.apiGet('recurso?WorkZoneID=' + login[0].WorkZone, login[0].token)
        ...
        handler: async () => {
          ...
          if (login) {
            try {
              ...
              const rs = await this.api.apiDelete('recurso?_id=' + point._id, login[0].token)
        ...
        handler: async (data) => {
          ...
          if (login) {
            try {
              ...
              const rs = await this.api.apiPost('recursoEdit', data)
        ...
        handler: async (data) => {
          ...
          if (login) {
            try {
              ...
              const rs = await this.api.apiPost('recurso', data)
