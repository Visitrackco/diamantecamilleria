...
//hhttps://diamanteticvisitrack.com
...
//https://diamanteticvisitrack.com
    ...
    getWMotivos(WorkZoneID: any, token, applyCOH?) {
        return fetch('https://diamanteticvisitrack.com/motivos?WorkZoneID=' + WorkZoneID + (applyCOH ? '&applyCOH=1' : ''), {
            method: 'GET',
            headers: {
                'x-token' : token
            }
